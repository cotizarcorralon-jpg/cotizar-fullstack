...
try {
    ...
    fs.writeFileSync('debug_result.json', JSON.stringify({ success: true, results }, null, 2));
} catch (e) {
    console.error("Parse failed!");
    console.error(e);
    fs.writeFileSync('debug_result.json', JSON.stringify({ success: false, error: e.toString(), stack: e.stack }, null, 2));
}
